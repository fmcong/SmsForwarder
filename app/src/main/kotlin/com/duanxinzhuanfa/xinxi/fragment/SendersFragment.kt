...
import com.duanxinzhuanfa.xinxi.adapter.SenderPagingAdapter
import com.duanxinzhuanfa.xinxi.adapter.WidgetItemAdapter
import com.duanxinzhuanfa.xinxi.core.BaseFragment
import com.duanxinzhuanfa.xinxi.database.entity.Sender
import com.duanxinzhuanfa.xinxi.database.viewmodel.BaseViewModelFactory
import com.duanxinzhuanfa.xinxi.database.viewmodel.SenderViewModel
import com.duanxinzhuanfa.xinxi.databinding.FragmentSendersBinding
import com.duanxinzhuanfa.xinxi.fragment.senders.BarkFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.DingtalkGroupRobotFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.DingtalkInnerRobotFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.EmailFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.FeishuAppFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.FeishuFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.GotifyFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.PushplusFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.ServerchanFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.SmsFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.SocketFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.TelegramFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.UrlSchemeFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.WebhookFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.WeworkAgentFragment
import com.duanxinzhuanfa.xinxi.fragment.senders.WeworkRobotFragment
import com.duanxinzhuanfa.xinxi.utils.KEY_SENDER_CLONE
import com.duanxinzhuanfa.xinxi.utils.KEY_SENDER_ID
import com.duanxinzhuanfa.xinxi.utils.KEY_SENDER_TYPE
import com.duanxinzhuanfa.xinxi.utils.Log
import com.duanxinzhuanfa.xinxi.utils.TYPE_BARK
import com.duanxinzhuanfa.xinxi.utils.TYPE_DINGTALK_GROUP_ROBOT
import com.duanxinzhuanfa.xinxi.utils.TYPE_DINGTALK_INNER_ROBOT
import com.duanxinzhuanfa.xinxi.utils.TYPE_EMAIL
import com.duanxinzhuanfa.xinxi.utils.TYPE_FEISHU
import com.duanxinzhuanfa.xinxi.utils.TYPE_FEISHU_APP
import com.duanxinzhuanfa.xinxi.utils.TYPE_GOTIFY
import com.duanxinzhuanfa.xinxi.utils.TYPE_PUSHPLUS
import com.duanxinzhuanfa.xinxi.utils.TYPE_SERVERCHAN
import com.duanxinzhuanfa.xinxi.utils.TYPE_SMS
import com.duanxinzhuanfa.xinxi.utils.TYPE_SOCKET
import com.duanxinzhuanfa.xinxi.utils.TYPE_TELEGRAM
import com.duanxinzhuanfa.xinxi.utils.TYPE_URL_SCHEME
import com.duanxinzhuanfa.xinxi.utils.TYPE_WEBHOOK
import com.duanxinzhuanfa.xinxi.utils.TYPE_WEWORK_AGENT
import com.duanxinzhuanfa.xinxi.utils.TYPE_WEWORK_ROBOT
...
class SendersFragment : BaseFragment<FragmentSendersBinding?>(),
    ...
    private var SENDER_FRAGMENT_LIST = listOf(
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.DingtalkGroupRobotFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.EmailFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.BarkFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.WebhookFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.WeworkRobotFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.WeworkAgentFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.ServerchanFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.TelegramFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.SmsFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
            R.drawable.icon_sms
        ),
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.FeishuFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.PushplusFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.GotifyFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.DingtalkInnerRobotFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.FeishuAppFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.UrlSchemeFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
        ...
        PageInfo(
            ...
            "com.duanxinzhuanfa.xinxi.fragment.senders.SocketFragment",
            "{\"\":\"\"}",
            CoreAnim.slide,
