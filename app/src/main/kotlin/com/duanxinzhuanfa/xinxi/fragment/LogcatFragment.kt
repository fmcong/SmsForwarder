...
import com.duanxinzhuanfa.xinxi.databinding.FragmentLogcatBinding
...
class LogcatFragment : BaseFragment<FragmentLogcatBinding?>() {
    ...
    private fun readLog(flush: Boolean) {
        ...
        lst.add("time")
        lst.add("-s")
        lst.add("GoLog,com.duanxinzhuanfa.xinxi.ForegroundService,com.duanxinzhuanfa.xinxi.server.ServerService")
