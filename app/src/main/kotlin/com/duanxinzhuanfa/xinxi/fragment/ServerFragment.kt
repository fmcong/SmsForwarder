...
import com.duanxinzhuanfa.xinxi.databinding.FragmentServerBinding
...
import com.duanxinzhuanfa.xinxi.utils.HTTP_SERVER_PORT
...
class ServerFragment : BaseFragment<FragmentServerBinding?>(), View.OnClickListener {
    ...
    override fun initListeners() {
        ...
        binding!!.sbApiLocation.setOnCheckedChangeListener { _: CompoundButton?, isChecked: Boolean ->
            ...
            if (ServiceUtils.isServiceRunning("com.duanxinzhuanfa.xinxi.service.HttpServerService")) {
