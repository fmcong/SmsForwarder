...
import com.duanxinzhuanfa.xinxi.utils.SP_BATTERY_INFO
import com.duanxinzhuanfa.xinxi.utils.SP_BATTERY_LEVEL
import com.duanxinzhuanfa.xinxi.utils.SP_BATTERY_PCT
import com.duanxinzhuanfa.xinxi.utils.SP_BATTERY_PLUGGED
import com.duanxinzhuanfa.xinxi.utils.SP_BATTERY_STATUS
import com.duanxinzhuanfa.xinxi.utils.SP_BLUETOOTH_STATE
import com.duanxinzhuanfa.xinxi.utils.SP_CONNECTED_DEVICE
import com.duanxinzhuanfa.xinxi.utils.SP_DATA_SIM_SLOT
import com.duanxinzhuanfa.xinxi.utils.SP_DISCOVERED_DEVICES
import com.duanxinzhuanfa.xinxi.utils.SP_IPV4
import com.duanxinzhuanfa.xinxi.utils.SP_IPV6
import com.duanxinzhuanfa.xinxi.utils.SP_IP_LIST
import com.duanxinzhuanfa.xinxi.utils.SP_LOCATION_INFO_NEW
import com.duanxinzhuanfa.xinxi.utils.SP_LOCATION_INFO_OLD
import com.duanxinzhuanfa.xinxi.utils.SP_LOCK_SCREEN_ACTION
import com.duanxinzhuanfa.xinxi.utils.SP_NETWORK_STATE
import com.duanxinzhuanfa.xinxi.utils.SP_SIM_STATE
import com.duanxinzhuanfa.xinxi.utils.SP_WIFI_SSID
import com.duanxinzhuanfa.xinxi.utils.SharedPreference
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_ALARM
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_CLEANER
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_FRPC
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_HTTPSERVER
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_NOTIFICATION
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_RESEND
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_RULE
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_SENDER
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_SENDSMS
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_SETTINGS
import com.duanxinzhuanfa.xinxi.utils.TASK_ACTION_TASK
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_APP
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_BATTERY
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_BLUETOOTH
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_CALL
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_CHARGE
...
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_LOCK_SCREEN
import com.duanxinzhuanfa.xinxi.utils.TASK_CONDITION_NETWORK
